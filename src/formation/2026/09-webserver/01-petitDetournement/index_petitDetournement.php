...
<p>
Pour trouver le flag, il suffit d'avoir le bon mot de passe (ou le contourner...)
</p>
...
<div style="margin-top: 30px; padding: 10px; border: 1px solid #ccc; border-radius: 8px; max-width: 500px;">
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $correctAnswer = "protectionContreLesInjection"; 
...
<div style="width: 100%; padding: 20px; border: 1px solid #aaa; border-radius: 8px; margin-top: 30px;">
    ...
    <div id="boxContent" style="display: none; margin-top: 20px; background: #f8f8f8; padding: 15px; border-radius: 6px;">
        ...
        <p>
	Pour vérifier les identifiants, une requête SQL est faite. il suffit de faire une simple injection SQL 
	</p>
...
<div style="width: 100%; padding: 20px; border: 1px solid #aaa; border-radius: 8px; margin-top: 30px;">
    ...
    <div id="counterContent" style="display: none; margin-top: 20px; background: #f8f8f8; padding: 15px; border-radius: 6px;">
        ...
        <h3>Contre‑mesures pour empêcher les injections SQL </h3>

	<ul>
	    <li>Utiliser des requêtes préparées (requêtes paramétrées) au lieu de concaténer des chaînes SQL</li>
	    <li>Valider et filtrer toutes les entrées utilisateur (types, formats, longueurs)</li>
	    <li>Limiter les privilèges SQL (principe du moindre privilège : pas d’admin pour l’application)</li>
	</ul>
	 ...
	 <li><strong>C08 - CODER</strong></li>
                <li>Bases de données et les environnements de traitement de données</li>
	</ul>
